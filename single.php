...
<?php setPostViews($post->ID); ?>  
                    ...
                    <article class="article reveal uk-animation-slide-left-small" id="lightgallery">
                        ...
                        <header class="article-header">
                         ...
                         <div class="article-comments" id="article-comments" style="margin-top:100px">
                             <iframe src="https://www.ouorz.com/wp-content/themes/peg/comm/index.html?id=<?php echo $post->ID; ?>" style="width: 100%;height: 70%;" frameborder="0" ></iframe>
                         </div>
                         </div>
                    </article>
